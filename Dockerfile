...
ENV APPSHELL_INDEX_URL=${APPSHELL_INDEX_URL:-'/appshell.index.json'}
ENV APPSHELL_METADATA_URL=${APPSHELL_METADATA_URL:-'/appshell.metadata.json'}
ENV APPSHELL_FETCH_METADATA=${APPSHELL_FETCH_METADATA}
